...
public class c_kartAngleCalc : MonoBehaviour {
	...
	if(c_kartcontroller.b_grounded ) {
		...
		t_box.rotation = Quaternion.Lerp(t_box.rotation,Quaternion.Euler(f_xAngle,transform.eulerAngles.y,f_zAngle),Time.deltaTime*4f);
		}
		else {
